...
export class ProfileService {
  ...
  {
     return this.http.get("https://api.github.com/users/" + this.username +"/repos?client_id="+this.clientid + "$client_secret=" +this.clientsecret+"?access_token="+environment.accessToken)
    .map(res=>res.json());
  }
  }
